...
window.APP = {
  ...
  plaatsen: [
    {
      ...
      verhaal_tekst: "Kerkrade is drie dingen tegelijk, en ze komen alle drie uit hetzelfde bos. Rond 1100 wordt hier land ontgonnen \u2014 rode betekent gerooid bos. In 1104 verschijnen er een klooster en een burcht, allebei Rode genoemd. Uit die ene naam komen er drie: \u2019s-Hertogenrode wordt Herzogenrath, de nederzetting bij de parochiekerk wordt Kerk-rade, en het klooster gaat als Rode-le-Duc door het leven, verbasterd tot Rolduc. In 1113 noteert die abdij het woord kalculen. Achthonderd jaar later is Kerkrade een mijnstad met duizenden koempels; op 29 augustus 1969 stopt de productie en verdwijnt het bijna volledig. Wat bleef: een grens die het gebied in 1815 doormidden sneed, en sinds 1951 elke vier jaar een muziekconcours.",
  ...
  pois: [
    ...
    },
    {
      ...
      verhaal_tekst: "Het idee komt niet van een gemeente of een mijndirectie, maar van één man. In 1939 opperde Kerkradenaar Jean Hermans, zoon van een bij een mijnongeval omgekomen vader, om een monument op te richten voor de mijnwerkers. Er gingen achttien jaar overheen. Beeldhouwer Wim van Hoorn maakte het bronzen beeld en op 16 juni 1957 werd het onthuld door Frans Houben, gouverneur van Limburg. Houben zei daarbij, in dialect: „Doa sjteet d'r Joep, inne echte köaler!” — daar staat d'r Joep, een echte kolenhouwer. Die zin bleef hangen, en zo kreeg het beeld zijn naam. Niet van de maker, niet van de opdrachtgever, maar van een spontane opmerking bij de onthulling.",
